...
function createInventionPages(){ //create invention pages and put them into an array
...
function getRandomNumber1_15(){ //generate random number from 0-14 
    let randomNumber= Math.floor(Math.random()*15);

    return randomNumber;
}

function randomPages(){ //generate three stolen pages randomly and no repeats
...
function continueOrQuit(winner){ //display the window with the choices: continue, reload or exit
    if(winner==="User"){
